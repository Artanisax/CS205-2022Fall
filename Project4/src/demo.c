...
int main () {
    ...
    float e1[200000], e2[200000];
    for (size_t i = 0; i < 200000; ++i) e1[i] = 1.0*rand()/rand();
    for (size_t i = 0; i < 200000; ++i) e2[i] = 1.0*rand()/rand();
    puts(" Initiallized");
    Matrix *m1 = createMatrix(300, 500, e1), *m2 = createMatrix(500, 300, e2);
    puts(" Created");
